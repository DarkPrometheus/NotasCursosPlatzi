...
export const NotaPrueba = () => {
    return (
        <div className="Nota__content">
            ...
            <h2 className="Nota__subTitle">Big data</h2>
            ...
            <h2 className="Nota__subTitle">Tipologia de datos</h2>
            <ul className="Nota__list">
                <li>Personas</li>
                <li>Transacciones</li>
            ...
            <h2 className="Nota__subTitle">Empresas data-driven</h2>
            ...
            <h2 className="Nota__subTitle">Machine learning</h2>
            <ul className="Nota__list">
            ...
            <h2 className="Nota__subTitle">Flujo de trabajo en ciencia de datos: fases, roles y oportunidades laborales</h2>
            ...
            <h2 className="Nota__subTitle">Herramientas para cada etapa del análisis de datos</h2>
